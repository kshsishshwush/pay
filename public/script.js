...
// ========== ДАННЫЕ БАНКОВ (полные, по 5-6 на страну) ==========
const banksData = {
    'russia': [
        ...
        { id: 'other',       name: 'Другой банк',        logo: 'russia-other.jpg' }
    ],
    'ukraine': [
        ...
        { id: 'raiffeisen-ua',name: 'Райффайзен Банк',  logo: 'ukraine-raiffeisen.jpg' },
        { id: 'ukreximbank',  name: 'Укрэксимбанк',     logo: 'ukraine-ukreximbank.jpg' },
        { id: 'other-ua',     name: 'Другой банк',       logo: 'ukraine-other.jpg' }
    ],
    'belarus': [
        { id: 'belarusbank',       name: 'Беларусбанк',       logo: 'belarus-belarusbank.jpg' },
        { id: 'belagroprombank',   name: 'Белагропромбанк',   logo: 'belarus-belagroprombank.jpg' },
        { id: 'priorbank',         name: 'Приорбанк',         logo: 'belarus-priorbank.jpg' },
        { id: 'belveb',            name: 'БелВЭБ',            logo: 'belarus-belveb.jpg' },
        { id: 'alfa-by',           name: 'Альфа-Банк',        logo: 'belarus-alfa.jpg' },
        { id: 'other-by',          name: 'Другой банк',        logo: 'belarus-other.jpg' }
    ],
    'kazakhstan': [
        { id: 'halyk',    name: 'Halyk Bank',        logo: 'kazakhstan-halyk.jpg' },
        { id: 'kaspi',    name: 'Kaspi Bank',         logo: 'kazakhstan-kaspi.jpg' },
        { id: 'bcc',      name: 'Bank CenterCredit', logo: 'kazakhstan-bcc.jpg' },
        { id: 'forte',    name: 'ForteBank',          logo: 'kazakhstan-forte.jpg' },
        { id: 'jusan',    name: 'Jusan Bank',         logo: 'kazakhstan-jusan.jpg' },
        { id: 'other-kz', name: 'Другой банк',        logo: 'kazakhstan-other.jpg' }
    ],
    'kyrgyzstan': [
        { id: 'demir',    name: 'Демир Банк',   logo: 'kyrgyzstan-demir.jpg' },
        { id: 'optima',   name: 'Оптима Банк',  logo: 'kyrgyzstan-optima.jpg' },
        { id: 'bakai',    name: 'Банк Бакай',   logo: 'kyrgyzstan-bakai.jpg' },
        { id: 'ayil',     name: 'Айыл Банк',    logo: 'kyrgyzstan-ayil.jpg' },
        { id: 'mbank',    name: 'Мбанк',        logo: 'kyrgyzstan-mbank.jpg' },
        { id: 'other-kg', name: 'Другой банк',   logo: 'kyrgyzstan-other.jpg' }
    ],
    'uzbekistan': [
        { id: 'nbu',         name: 'Нац. банк Узбекистана', logo: 'uzbekistan-nbu.jpg' },
        { id: 'asaka',       name: 'Асака банк',             logo: 'uzbekistan-asaka.jpg' },
        { id: 'uzpromstroy', name: 'Узпромстройбанк',        logo: 'uzbekistan-uzpromstroy.jpg' },
        { id: 'ipoteka',     name: 'Ипотека банк',           logo: 'uzbekistan-ipoteka.jpg' },
        { id: 'halk',        name: 'Халк банк',              logo: 'uzbekistan-halk.jpg' },
        { id: 'other-uz',    name: 'Другой банк',             logo: 'uzbekistan-other.jpg' }
    ],
    'tajikistan': [
        { id: 'amonatbonk', name: 'Амонатбонк',         logo: 'tajikistan-amonatbonk.jpg' },
        { id: 'orienbonk',  name: 'Ориёнбонк',          logo: 'tajikistan-orienbonk.jpg' },
        { id: 'ehjoi',      name: 'Бонки Эхёи Ватан',   logo: 'tajikistan-ehjoi.jpg' },
        { id: 'kafolat',    name: 'Бонки Кафолат',       logo: 'tajikistan-kafolat.jpg' },
        { id: 'arvand',     name: 'Бонки Арванд',        logo: 'tajikistan-arvand.jpg' },
        { id: 'other-tj',   name: 'Другой банк',          logo: 'tajikistan-other.jpg' }
    ]
};
...
const currencyRates = {
    'russia':     { code: 'RUB', symbol: '₽',  rate: 1 },
    'ukraine':    { code: 'UAH', symbol: '₴',  rate: 0.37 },
    'belarus':    { code: 'BYN', symbol: 'Br', rate: 0.032 },
    'kazakhstan': { code: 'KZT', symbol: '₸',  rate: 4.8 },
    'kyrgyzstan': { code: 'KGS', symbol: 'с',  rate: 0.9 },
    'uzbekistan': { code: 'UZS', symbol: "so'm", rate: 126 },
    'tajikistan': { code: 'TJS', symbol: 'SM', rate: 0.094 }
};
...
function checkForDealInURL() {
    ...
    if (path.startsWith('/DEAL-') || path.startsWith('/deal/DEAL-')) {
        const token = path.replace('/deal/', '').replace('/', '');
...
async function loadDealByToken(token) {
    ...
    history.pushState({section: 'deal', token: token}, '', '/' + token);
...
let dealCreationState = {
    country: null, bank: null, bankId: null, bankLogo: null,
    method: null, details: null, recipient: null, amount: 0
};
...
function backToDealCountries() {
    document.getElementById('deal-bank-selection-panel').style.display = 'none';
    document.getElementById('deal-banks-list').innerHTML = '';
    toggleDealCountrySelection();
}
...
function selectDealMethod(method) {
    ...
    let methodText = method === 'phone' ? 'перевод по номеру телефона'
